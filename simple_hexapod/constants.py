...
if ROBOT_TYPE == PHANTOMX:
...
elif ROBOT_TYPE == PHANTOMX_RL:
    constL1 = 0.0548
    constL2 = 0.0653
    constL3 = 0.133  # Approximate value (different from real robot and couldn't find value in URDF yet)
    ...
    USE_MM_OUTPUT = False
    Z_DIRECTION = -1
    #LEG_ANGLES = [math.pi / 2, 0, 0, -math.pi / 2, math.pi, math.pi]#BIOLOID ANGLES
