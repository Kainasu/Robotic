...
class SimpleRobot:
    def __init__(self, dxl_io):
        ...
        self.legs = {
            ...
            ######
            # 3: [SimpleMotor(8), SimpleMotor(10), SimpleMotor(12)],
            # 2: [SimpleMotor(14), SimpleMotor(16), SimpleMotor(18)],
            # 1: [SimpleMotor(13), SimpleMotor(15), SimpleMotor(17)],
            # 6: [SimpleMotor(7), SimpleMotor(9), SimpleMotor(11)],
            # 5: [SimpleMotor(1), SimpleMotor(3), SimpleMotor(5)],
            # 4: [SimpleMotor(2), SimpleMotor(4), SimpleMotor(6)],
        }
